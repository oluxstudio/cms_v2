...
useHead({ title: 'Privacy Policy — CAC Blackburn' })

// Blocks render in the CMS-configured order (original order as fallback).
const oluxBlocks: Record<string, any> = { 'site-header': SiteHeader, 'page-hero-content': PageHeroContent, 'legal-doc': LegalDoc, 'site-footer': SiteFooter }
const oluxPage = useOluxPageOrder('/privacy-policy', oluxBlocks)
