...
useHead({ title: 'Give — CAC Blackburn' })

// Blocks render in the CMS-configured order (original order as fallback).
const oluxBlocks: Record<string, any> = { 'site-header': SiteHeader, 'page-hero-content': PageHeroContent, 'donate-giving': DonateGiving, 'times': TimesBlock, 'site-footer': SiteFooter }
const oluxPage = useOluxPageOrder('/donate', oluxBlocks)
