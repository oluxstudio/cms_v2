...
import BroadcastChannels from '~/components/BroadcastChannels.vue'
import SermonsBlock from '~/components/SermonsBlock.vue'
import TimesBlock from '~/components/TimesBlock.vue'
import SiteFooter from '~/components/SiteFooter.vue'

useHead({ title: 'Live Broadcast — CAC Blackburn' })

// Blocks render in the CMS-configured order (original order as fallback).
const oluxBlocks: Record<string, any> = { 'site-header': SiteHeader, 'page-hero-content': PageHeroContent, 'broadcast-channels': BroadcastChannels, 'sermons': SermonsBlock, 'times': TimesBlock, 'site-footer': SiteFooter }
const oluxPage = useOluxPageOrder('/broadcast', oluxBlocks)
