...
const oluxBlocks: Record<string, any> = { 'site-header': SiteHeader, 'about': AboutBlock, 'team': TeamBlock, 'contact': ContactBlock, 'site-footer': SiteFooter, 'faq': FaqBlock, 'hero': HeroBlock, 'services': ServicesBlock }
