    ...
    <div class="flex flex-wrap items-center gap-2 mb-5">
        ...
        <div class="ml-auto relative">
            ...
            <input wire:model.live.debounce.300ms="search" type="text" placeholder="Search contacts…"
                   class="pl-9 pr-4 py-2 w-56 bg-white dark:bg-[#1d1e2a] border border-gray-200 dark:border-white/[0.08] rounded-xl text-sm text-gray-700 dark:text-gray-200 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-all">
        </div>
    </div>
