...
class ArrayTemplate implements TemplateContract
{
    ...
    public function key(): string           { return (string) $this->m('key', 'custom'); }
    public function name(): string          { return (string) $this->m('name', 'Custom Template'); }
    ...
    public function author(): string        { return (string) $this->m('author', 'Imported'); }
    ...
    public function thumbnail(): ?string    { return $this->thumbnailUrl; }
}
