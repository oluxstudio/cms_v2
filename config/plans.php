...
return [
    ...
    'tiers' => [
        'trial' => [
            ...
            'color' => '#f59e0b',
            'accent' => 'cocoa',
            'limits' => ['sites' => 1, 'premium' => true, 'storage_mb' => 100, 'marketplace' => false],
        ...
        'starter' => [
            ...
            'color' => '#0ea5e9',
            'accent' => 'sky',
            'limits' => ['sites' => 1, 'premium' => false, 'storage_mb' => 1024, 'marketplace' => false],
        ...
        'pro' => [
            ...
            'accent' => 'lime',
            'highlight' => true,
            'limits' => ['sites' => 5, 'premium' => true, 'storage_mb' => 5120, 'marketplace' => false],
        ...
        'business' => [
            ...
            'color' => '#10b981',
            'accent' => 'lavender',
            'limits' => ['sites' => 10, 'premium' => true, 'storage_mb' => 20240, 'marketplace' => true],
        ...
        'enterprise' => [
            ...
            'color' => '#a855f7',
            'accent' => 'primary',
            'limits' => ['sites' => null, 'premium' => true, 'storage_mb' => null, 'marketplace' => true], // null = unlimited
